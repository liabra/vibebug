...
const MODES = [
  ...
  {
    id: 'reconstruct',
    eyebrow: 'Logique d\'exécution',
    icon: '🔧',
    title: 'Reconstruct Script',
    desc: 'Les blocs d\'un script sont dans le désordre. Remets-les dans le bon ordre d\'exécution. Un entraînement direct sur la logique des scripts Bash et des séquences de déploiement.',
    promise: 'Comprendre l\'ordre, c\'est comprendre pourquoi ça plante.',
    tags: ['5 défis', 'Ordre logique', '+20 XP / bonne réponse'],
    btn: 'Lancer les défis →',
    path: '/reconstruct',
    theme: {
      bg: '#f5f3ff',
      border: '#c4b5fd',
