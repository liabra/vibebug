...
export default function NetworkLevelsPage() {
  ...
  const levelEntries = Object.entries(networkChallenges)
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        ...
        <div>
          <h1 style={styles.heading}>Réseau</h1>
          <p style={styles.subheading}>DNS, connectivité, ports — diagnostique les pannes au lieu de relancer à l'aveugle</p>
        </div>
      </div>
